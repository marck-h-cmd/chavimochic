                ...
                <?php foreach ($users as $u): ?>
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 flex items-center justify-center space-x-4">
                            <a href="/chavimochic/src/Views/administrador/general/managementusers/editusers.php?id=<?= $u->id ?>"
    ...
    <div class="bg-white p-4 rounded shadow-lg max-w-5xl w-full max-h-screen overflow-y-auto relative">
        ...
        <form action="/chavimochic/src/contenido/store_user.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="career" name="career" class="w-full px-4 py-2 border rounded"
                    value="<?= htmlspecialchars($old['career'] ?? '') ?>" required>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <select id="tipo" name="tipo" class="w-full px-4 py-2 border rounded" required>
